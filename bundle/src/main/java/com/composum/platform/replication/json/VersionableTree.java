...
public class VersionableTree {
    ...
    public List<VersionableInfo> getDeleted() {
        if (deleted == null) { throw new IllegalStateException("Object was not deserialized."); }
        return deleted;
    }
    ...
    public List<VersionableInfo> getChanged() {
        if (changed == null) { throw new IllegalStateException("Object was not deserialized."); }
        return changed;
    }
    ...
    public static class VersionableTreeSerializer extends AbstractJsonTypeAdapterFactory<VersionableTree> {
        ...
        protected void traverseTree(Resource resource, JsonWriter out, Gson gson) throws IOException {
            ...
            if (ResourceUtil.isNodeType(resource, ResourceUtil.TYPE_VERSIONABLE)) {
                ...
                if (info != null) { gson.toJson(info, VersionableInfo.class, out); }
