...
public class NodeAttributeComparisonInfoTest {
    ...
    protected Map<String, Object> makeProperties(Calendar calendar) {
        return Map.of(PROP_PRIMARY_TYPE, TYPE_UNSTRUCTURED,
                PROP_MIXINTYPES, new String[]{MIX_CREATED, MIX_VERSIONABLE},
                "num", 15,
                "str", "hello!",
                "longstr", "This is a very very very long string that should be encoded as hash to make it shorter",
                "date", calendar,
                "long", 1579778715114L,
                "double", Math.PI,
                "bigdec", BigDecimal.valueOf(123, 1),
                "stream", new ByteArrayInputStream("somecontent".getBytes(StandardCharsets.UTF_8)));
    }
