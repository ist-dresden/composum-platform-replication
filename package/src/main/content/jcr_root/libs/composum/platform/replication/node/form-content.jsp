        ...
        <div class="col col-xs-3">
            <div class="form-group">
                ...
                <input type="checkbox" name="enabled" data-value="${model.enabled}"
                       class="composum-platform-replication-node_enabled widget checkbox-widget form-control"/>
            </div>
        </div>
        <div class="col col-xs-9">
            <div class="form-group">
                ...
                <input type="text" name="jcr:title" value="${model.property._jcr_title}"
                       class="composum-platform-replication-node_title widget text-field-widget form-control"/>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col col-xs-3">
            <div class="form-group">
                ...
                <select name="stage" data-value="${model.stage}" data-default="public" data-rules="required"
                        ...
                        class="composum-platform-replication-node_stage widget select-widget form-control"></select>
            </div>
        </div>
        <div class="col col-xs-9">
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="targetPath" value="${model.targetPath}"
                       class="composum-platform-replication-node_target-path widget text-field-widget form-control"/>
            </div>
        </div>
    </div>
</cpn:component>
