...
<cpn:component var="model" type="com.composum.platform.replication.model.ReplicationConfigNode" scope="request">
    <div class="composum-platform-replication-config-node${model.editable?' editable':''}">
        ...
        <div class="form-group">
            ...
            <div class="composum-platform-replication-config-node_description composum-widgets-richtext richtext-widget widget form-control"
                 data-rules="blank">
